...
if __name__ == "__main__":
    ...
    if args.base_model == "sdxl":
        ...
        raise ValueError("Choose base model from these options: ['sdxl', 'sd15', 'animagine']")
    ...
    #     directory = os.path.join(args.data_path, path)
    #     if idx == 0:
    #         unique = True
    #     else:
    #         unique = False
    ...
    #     processed_data_path = preprocess(directory, methods=methods, unique_folder=unique, save_folder=args.store_folder)
    ...
    output_path = generate_folder(args.data_path, unique_folder=True)
    print("output_path: ", output_path)
